...
template <typename T>
GenericImage<T>::GenericImage() : d_channels(3), d_rows(0), d_cols(0), d_pixels(0) { }

template <typename T>
GenericImage<T>::GenericImage(int rows, int cols) : d_channels(3), d_rows(rows), d_cols(cols), d_pixels(rows * cols * d_channels) { }
